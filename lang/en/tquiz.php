...
$string['returntoattempts'] = 'Return to Attempts';
...
$string['attemptheader'] = '{$a->tquizname} attempt details for {$a->username} on {$a->attemptdate}';
...
$string['logs'] = 'logs';
$string['nodataavailable'] = 'No data avaailable for display';
